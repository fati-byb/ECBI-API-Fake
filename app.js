...
const cors = require('cors');
const path = require('path');
const apiRouter = require('./routes/index.routes'); // Assure-toi que le fichier de routes est correctement référencé
require('./config/passport')(passport);
...
//-------------- Routes --------------//
// Utilisation du préfixe /api pour toutes les routes dans index.routes
